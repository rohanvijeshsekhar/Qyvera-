(function () {
  ...
  const T = {
    ...
    'info.meta.status': 'Founders',
    'info.meta.based.value': 'Vannes, France',
    'info.meta.status.value': 'Rohan Sekhar & Pooja Prasad',
    ...
    'contact.meta.status': 'Founders',
    'contact.meta.delay': 'Avg. response',
    'contact.meta.base.value': 'Vannes, France',
    'contact.meta.status.value': 'Rohan Sekhar & Pooja Prasad',
